    ...
    blocks: [
      ...
      { t: 'h', text: 'Vangnetten' },
      {
        ...
        items: [
          ...
          '**Versterker-vloer (systeem-Z ≥ 3 Ω)**: de simulatie stuurt spanning, dus een impedantie-dip is onzichtbaar in elke responsmetriek — alleen de versterker voelt hem. Duikt het getunede resultaat onder de vloer, dan volgt een lokale reparatie-retune (alleen geaccepteerd als de respons in klasse blijft); lukt dat niet, dan meldt de note het en toont het Impedance-paneel de dip. Bewust géén term in de zoek-objective: zelfs een minuscule bijdrage verlegt het deterministische zoekpad (gemeten: 6 dB slechter bekken).',
