...
export const nl: Record<string, string> = {
  ...
  "Exported {zip} — {vxp} + {n} measurement file(s) ({variants}). {bridge}. Unpack it and open {vxp} in VituixCAD.": "{zip} geëxporteerd — {vxp} + {n} meetbestand(en) ({variants}). {bridge}. Pak hem uit en open {vxp} in VituixCAD.",
  ...
  "Stop searching and rank the candidates that already finished — the best of those is loaded, the rest is never computed. The scan table shows which ones ran.": "Stop met zoeken en rangschik de kandidaten die al klaar zijn — de beste daarvan wordt geladen, de rest wordt niet meer uitgerekend. De scan-tabel laat zien welke gedraaid hebben.",
  "Use the 1 finished result": "Gebruik het 1 afgeronde resultaat",
  "Use the {n} finished results": "Gebruik de {n} afgeronde resultaten",
  "Stopped before any candidate finished — nothing was changed. Your design is exactly as it was.": "Gestopt voordat één kandidaat klaar was — er is niets gewijzigd. Je ontwerp is precies zoals het was.",
  "Measurement": "Meting",
  "Verdict": "Oordeel",
  ...
  "Loading the 2-way demo…": "2-weg-demo laden…",
  "2-way demo loaded — {label}: midrange (merged near/far field) + tweeter, the measured cabinet and the requirements casus 1b states": "2-weg-demo geladen — {label}: mid (gemergd nabij/ver veld) + tweeter, de gemeten kast en de eisen die casus 1b stelt",
  ...
  "Load the 2-way demo (KOAN mid + tweeter)": "Laad de 2-weg-demo (KOAN mid + tweeter)",
  "casus 1b: merged near/far field, gated tweeter, stated requirements": "casus 1b: gemergd nabij/ver veld, gepoorte tweeter, gestelde eisen",
  "Load 2-way demo (KOAN mid + tweeter)": "Laad 2-weg-demo (KOAN mid + tweeter)",
  "Load the bundled KOAN 2951 mid + tweeter as a two-way (casus 1b, Aug 2026): the merged midrange, the gated tweeter, both impedances, the measured cabinet and the requirements that casebook states": "Laad de meegeleverde KOAN 2951-mid en -tweeter als tweeweg (casus 1b, aug 2026): de gemergede mid, de gepoorte tweeter, beide impedanties, de gemeten kast en de eisen die dat casusboek stelt",
