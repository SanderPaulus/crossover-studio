...
4. **Determinisme.** Zelfde invoer + zelfde seed = byte-identiek resultaat; seed- en budgetbeleid vastleggen, anders zijn golden references onbetrouwbaar.
